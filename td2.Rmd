...
Cette semaine, nous allons utiliser une nouvelle base de données Tourisme Emploi [trouvée sur le site de l'OCDE](https://stats.oecd.org/BrandedView.aspx?oecd_bv_id=d2b36bc8-fr&doi=fd945dec-fr) mais que vous pouvez directement télécharger dans la version que j'utilise en cliquant sur [le lien ici.](https://drive.google.com/file/d/1jl4PE7LC-pZj5Gac2kYs0E19tzL8RC5i/view?usp=sharing). 

Petite parenthèse, je vous conseille de chercher les données directement via ce site dont l'interface est moins jolie mais qui est bien plus efficace pour accéder aux données rapidement dans le menu de gauche : [cliquez ici](https://stats.oecd.org/index.aspx?r=647489)

![Capture d'écran du site données](td2/ocde.jpg)

Enfin, je vous propose de retrouver le script de cette séance [ici](https://drive.google.com/file/d/1COVtXes910oz2ViOeZHfkC2ns0xfsfnL/view?usp=sharing).
